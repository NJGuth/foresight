  ...
  return (
    <div className=" px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 ">
        <p className="text-base/7 font-semibold text-primary">Introducing</p>
        <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-foreground-muted sm:text-5xl">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <ul
            role="list"
            className="mt-8 max-w-xl space-y-8 text-muted-foreground"
          >
            ...
            <li className="flex gap-x-3">
              ...
              />
              <span>
                <strong className="font-semibold">Loops.</strong> Anim aute id
            ...
            <li className="flex gap-x-3">
              ...
              />
              <span>
                <strong className="font-semibold">Events.</strong> Ac tincidunt
                sapien vehicula erat auctor pellentesque rhoncus. Et magna sit
                morbi lobortis.
              </span>
            </li>
          </ul>
          ...
          <h2 className="mt-16 text-3xl font-semibold tracking-tight text-pretty">
