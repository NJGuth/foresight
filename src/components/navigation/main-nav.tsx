        ...
        <SidebarMenuItem key={item.title} className="px-0.5">
          <SidebarMenuButton
            ...
            className={cn(
              ...
              item.color === "blue" &&
                "data-[active=true]:text-blue-11 hover:text-blue-11 active:text-blue-11/90 data-[active=true]:bg-blue-3 hover:bg-blue-3 active:bg-blue-4",
              item.color === "green" &&
                "data-[active=true]:text-green-11 hover:text-green-11 active:text-green-11/90 data-[active=true]:bg-green-3 hover:bg-green-3 active:bg-green-4",
              item.color === "purple" &&
                "data-[active=true]:text-purple-11 hover:text-purple-11 active:text-purple-11/90 data-[active=true]:bg-purple-3 hover:bg-purple-3 active:bg-purple-4",
              item.color === "orange" &&
                "data-[active=true]:text-orange-11 hover:text-orange-11 active:text-orange-11/90 data-[active=true]:bg-orange-3 hover:bg-orange-3 active:bg-orange-4",
              item.color === "crimson" &&
