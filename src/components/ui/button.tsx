  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm/6 font-semibold transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive ",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:border-accent-border hover:bg-accent hover:text-accent-foreground scale-100 active:scale-95 ease-out duration-300 transition-all",
        secondary:
          "bg-secondary/90  text-secondary-foreground  hover:bg-secondary/80 hover:ring-1 hover:ring-primary/80 hover:ring-offset-1 hover:ring-offset-background scale-100 active:scale-95 ease-out duration-300 transition-all",
